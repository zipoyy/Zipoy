...
document.querySelectorAll('.skill-card, .achievement-card, .timeline-item, .education-card').forEach(el => {
    observer.observe(el);
});
...
document.querySelectorAll('.skill-card, .achievement-card, .education-card').forEach(card => {
